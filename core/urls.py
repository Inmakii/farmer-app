...
urlpatterns = [
    ...
    path("cultivations/<int:pk>/", CultivationDetailView.as_view(), name="cultivation_detail"),
    path("cultivations/<int:pk>/edit/", CultivationUpdateView.as_view(), name="cultivation_update"),
    path("cultivations/<int:pk>/delete/", CultivationDeleteView.as_view(), name="cultivation_delete"),
